...
<html>
    ...
    <body>
        ...
        <div id="container">
            <div id="upper">
                <label for="username", class="username-label">Logged in as <br><?php echo $_SESSION['authenticated'] ? $_SESSION['username'] : "Guest" ?></label>
        ...
        <?php
            $days = ["day" => ["Lundi", "Mardi", "Mercredi", "Jeudi", "Vendredi"]];
        ...
        <div class="modal" id="modal">
            <div class="modal-header" id="modal-header">
                ...
                <!-- <?php comboBox("day_choice", $days) ?> -->
                <div id='day_choice'></div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-content-end">
                    ...
                    <div class="end_select">
                        <?php comboBox("end_hour", $hours); print(":"); comboBox("end_min", $mins); ?>
                    </div>
                </div>
                <div class="subject">
                    <div>Matière: </div>
